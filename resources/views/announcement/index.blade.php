        ...
        <div class="row">
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="card-body">
                    <img style="border-radius:5px; " class="img-fluid" src={{!$announcement->images()->get()->isEmpty() ? Storage::url($announcement->images()->first()->path) : "https://picsum.photos/400/400"}} alt="immagine">
