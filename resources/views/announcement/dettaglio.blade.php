<x-layout>
    ...
    <div style="align-items:center; justify-content:center" class="row m-2  d-flex  text-center">
        ...
        <div
            class="card m-4 col-12 col-md-6"style="width: 40rem; box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset; ">
            <div class="card-body">
                        ...
                        <div class="carousel-inner">
                            @foreach ($announcement->images as $image)
                                <div class="carousel-item @if ($loop->first) active @endif">
                                    <img src={{ $image->getUrl(400, 400) }} class="img-fluid p-3 rounded" alt="">
                                </div>
                            @endforeach
                        </div>
                    @else
                ...
                <p class="card-text"><a style="text-decoration: none; color:black"
                        ...
                        {{ __('ui.category') }} : {{ __('categories.' . $announcement->category->name) }}</a></p>
                ...
                <form action="{{ route('cart.add', ['announcement' => $announcement->id])}}" method="POST">
                    ...
                    <button style="background: #2414da; width:100%;" type="submit"
